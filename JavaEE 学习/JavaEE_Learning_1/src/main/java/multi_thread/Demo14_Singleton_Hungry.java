...
public class Demo14_Singleton_Hungry {
    // 饿汉
    // 迫不及待，程序一启动就直接创建单例
    ...
    private static Demo14_Singleton_Hungry singletonHungry = new Demo14_Singleton_Hungry();
    public String info;
    // 私有化构造方法，防止在类外 new 这个对象
    private Demo14_Singleton_Hungry() {
    ...
    // 所以要通过类访问静态成员方法
    public static Demo14_Singleton_Hungry getInstance(){
