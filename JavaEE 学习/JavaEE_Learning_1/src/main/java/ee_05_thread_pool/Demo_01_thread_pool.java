...
public class Demo_01_thread_pool {
    // 表示火锅店有 10 个等饭位
    public static ArrayBlockingQueue<Runnable> workQueue = new ArrayBlockingQueue<>(10);

    public static void main(String[] args) throws InterruptedException {
        MyThreadPool myThreadPool = new MyThreadPool(3, 5, 3, TimeUnit.SECONDS, workQueue);
        for (int i = 0; i < 10; i++) {
            int taskId = i;
            myThreadPool.submit(()->{
